...
export default function ResumenCredito() {
  ...
  async function descargarImagen() {
    ...
    enlace.download = "resumen-credito.png";
      ...
      <div className="w-full max-w-2xl">
        <div className="flex items-center justify-between py-6 print:hidden">
          <div>
            ...
            <h1 className="text-2xl font-bold text-navy">Resumen de crédito</h1>
          </div>
          {datos && (
        ...
        {!datos ? (
          ...
          <div ref={recuadroRef} className="reporte-imprimible rounded-2xl bg-white p-6 shadow shadow-slate-200">
            ...
            <div className="mb-4">
              ...
              <p className="mt-2 text-xl font-bold">Resumen de crédito</p>
