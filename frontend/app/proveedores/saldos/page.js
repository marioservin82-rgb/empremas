...
export default function ResumenDeudasProveedores() {
  ...
  async function descargarImagen() {
    ...
    enlace.download = "resumen-deudas-proveedores.png";
      ...
      <div className="w-full max-w-2xl">
        <div className="flex items-center justify-between py-6 print:hidden">
          <div>
            ...
            <h1 className="text-2xl font-bold text-navy">Resumen de deudas a proveedores</h1>
          </div>
          {datos && (
        ...
        {!datos ? (
          ...
          <div ref={recuadroRef} className="reporte-imprimible rounded-2xl bg-white p-6 shadow shadow-slate-200">
            ...
            <div className="mb-4">
              ...
              <p className="mt-2 text-xl font-bold">Resumen de deudas a proveedores</p>
            ...
            <div className="mb-6 rounded-2xl bg-slate-50 p-5 text-center">
              <p className="text-sm text-slate-400">Total por pagar</p>
              <p className="text-3xl font-extrabold text-ink">Gs {formatoGs.format(datos.totalPorPagar)}</p>
            </div>
